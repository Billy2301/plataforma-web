...
;(function () {
    ...
    var _defaults = {
        ...
        sounds: {
            ...
            info: "../assets/libs/Toasty/sounds/info/1.mp3",
            // path to sound for successfull message:
            success: "../assets/libs/Toasty/sounds/success/1.mp3",
            // path to sound for warn message:
            warning: "../assets/libs/Toasty/sounds/warning/1.mp3",
            // path to sound for error message:
            error: "../assets/libs/Toasty/sounds/error/1.mp3",
        },
