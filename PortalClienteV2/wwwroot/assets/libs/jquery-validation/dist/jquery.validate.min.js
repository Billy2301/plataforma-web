    ...
    a.extend(a.expr.pseudos || a.expr[":"], {
        ...
        a.extend(a.validator, {
            ...
            messages: {
                ...
                minlength: a.validator.format("Por favor, introduce al menos {0} caracteres."),
                rangelength: a.validator.format("Por favor, introduce un valor entre {0} y {1} caracteres de longitud."),
                range: a.validator.format("Por favor, introduce un valor entre {0} y {1}."),
                max: a.validator.format("Por favor, introduce un valor menor o igual a {0}."),
                min: a.validator.format("Por favor, introduce un valor mayor o igual a {0}."),
                step: a.validator.format("Por favor, introduce un múltiplo de {0}.")
            },
            autoCreateRanges: !1,
            prototype: {
                init: function () {
