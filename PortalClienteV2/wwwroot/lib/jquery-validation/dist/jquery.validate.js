	...
	validate: function( options ) {
		...
		if ( !this.length ) {
			if ( options && options.debug && window.console ) {
				console.warn( "No se seleccionó nada, no se puede validar y no se devuelve nada." );
			}
			return;
		}
			...
			for ( method in rules ) {
				...
				try {
					...
					if ( this.settings.debug && window.console ) {
						console.log( "Se produjo una excepción al verificar el elemento. " + element.id + ", check the '" + rule.method + "' method.", e );
					}
